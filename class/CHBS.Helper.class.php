...
class CHBSHelper
{
	...
	static function getFormattedAddress($bookingMeta)
	{
		$Validation=new CHBSValidation();
				
		if((array_key_exists('address',$bookingMeta)) && ($Validation->isNotEmpty($bookingMeta['address']))) return($bookingMeta['address']);
