...
class CHBSAVRule
{
	...
	function manageEditColumns($column)
	{
		...
		(
			'cb'=>$column['cb'],
			'title'=>$column['title'],
			'detail'=>__('Conditions and details','chauffeur-booking-system')
		);
			...
			case 'detail':
				...
				'
					<table class="to-table-post-list">
						...
						<tr>
							<td>'.esc_html__('Fixed pickup location','chauffeur-booking-system').'</td>
							<td>'.$this->displayPricingRuleAdminListValue($meta['location_fixed_pickup'],$dictionary['location'],true,true).'</td>
						</tr>
						<tr>
							<td>'.esc_html__('Fixed drop off location','chauffeur-booking-system').'</td>
						...
						<tr>
							<td>'.esc_html__('Return geofence','chauffeur-booking-system').'</td>
