...
?>								
								...
								<li>
									<h5><?php esc_html_e('Ride time roundng','chauffeur-booking-system'); ?></h5>
									<span class="to-legend">
								...
								<li>
									...
									<div class="to-clear-fix">
										<input maxlength="12" type="text" name="<?php CHBSHelper::getFormName('booking_form_post_id'); ?>" id="<?php CHBSHelper::getFormName('booking_form_post_id'); ?>" value="<?php echo esc_attr($this->data['meta']['booking_form_post_id']); ?>"/>
									</div> 
								</li> 				
							</ul>					
						</div>						
...
?>								
						...
						<div id="meta-box-booking-form-1-6">
							<div class="ui-tabs">
								<ul>
									<li><a href="#meta-box-booking-form-1-6-1"><?php esc_html_e('Main','chauffeur-booking-system'); ?></a></li>
									<li><a href="#meta-box-booking-form-1-6-2"><?php esc_html_e('Step #1','chauffeur-booking-system'); ?></a></li>
									<li><a href="#meta-box-booking-form-1-6-3"><?php esc_html_e('Step #2','chauffeur-booking-system'); ?></a></li>
									<li><a href="#meta-box-booking-form-1-6-4"><?php esc_html_e('Step #3','chauffeur-booking-system'); ?></a></li>
									<li><a href="#meta-box-booking-form-1-6-5"><?php esc_html_e('Step #4','chauffeur-booking-system'); ?></a></li>
									<li><a href="#meta-box-booking-form-1-6-6"><?php esc_html_e('Step #5','chauffeur-booking-system'); ?></a></li>
								</ul>	 
								<div id="meta-box-booking-form-1-6-1">		
									<ul class="to-form-field-list">
										<li>
								...
								<div id="meta-box-booking-form-1-6-2">		
									<ul class="to-form-field-list">
										<li>
								...
								<div id="meta-box-booking-form-1-6-3">		
									<ul class="to-form-field-list">
										<li>
								...
								<div id="meta-box-booking-form-1-6-4">		
									<ul class="to-form-field-list">
										<li>
...
?>								
								...
								<div id="meta-box-booking-form-1-6-5">		
									<ul class="to-form-field-list">
										<li>
								...
								<div id="meta-box-booking-form-1-6-6">		
									<ul class="to-form-field-list">
										<li>
...
?>
						...
						<li>
							<h5><?php esc_html_e('SMS notifications (Nexmo)','chauffeur-booking-system'); ?></h5>
							<span class="to-legend">
						...
						<li>
							<h5><?php esc_html_e('SMS notifications (Twilio)','chauffeur-booking-system'); ?></h5>
							<span class="to-legend">
						...
						<li>
							<h5><?php esc_html_e('SMS customer notifications','chauffeur-booking-system'); ?></h5>
							<span class="to-legend">
								<?php echo __('Enter notification details sent to the customer after sending the booking.','chauffeur-booking-system'); ?><br/>
								<?php echo sprintf(__('You can use shortcodes like: [%s_pickup_location],[%s_dropoff_location],[%s_pickup_date],[%s_pickup_time],[%s_vehicle_name],[%s_booking_sum_gross] in the message.','chauffeur-booking-system'),PLUGIN_CHBS_CONTEXT,PLUGIN_CHBS_CONTEXT,PLUGIN_CHBS_CONTEXT,PLUGIN_CHBS_CONTEXT,PLUGIN_CHBS_CONTEXT,PLUGIN_CHBS_CONTEXT); ?><br/>
								<?php echo __('Note that "Status" option of Twilio and Nexmo settings doesn\'t matter in case of sending notification to the customer.','chauffeur-booking-system'); ?>
							</span> 
							<div class="to-clear-fix">
								<span class="to-legend-field"><?php esc_html_e('Status:','chauffeur-booking-system'); ?></span>
								<div class="to-radio-button">
									...
									<label for="<?php CHBSHelper::getFormName('customer_sms_enable_2'); ?>"><?php esc_html_e('Enable via Nexmo','chauffeur-booking-system'); ?></label>
							...
							<div>
								<span class="to-legend-field"><?php esc_html_e('Text message:','chauffeur-booking-system'); ?></span>
