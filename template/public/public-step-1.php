...
?>
						<div class="chbs-clear-fix">
							...
							<div class="chbs-form-field chbs-form-field-width-<?php echo esc_attr($passengerDisplay ? '33' : '50') ?>">
								...
								<input type="text" autocomplete="off" name="<?php CHBSHelper::getFormName('pickup_time_service_type_1'); ?>" class="chbs-timepicker" value="<?php echo esc_attr($this->data['booking_edit']->getFieldValue('pickup_time',array('meta','pickup_time'),1)); ?>"/>
							</div>
<?php
			if($passengerDisplay)
			{
...
<?php
				...
				{
?>
							<input name="<?php CHBSHelper::getFormName('fixed_location_pickup_service_type_1_autocomplete'); ?>" class="chbs-form-field-location-fixed-autocomplete" type="text" value="<?php echo esc_attr(is_null(CHBSRequestData::getFromWidget(1,'fixed_location_pickup_id')) ? '' : $this->data['meta']['location_fixed_pickup_service_type_1'][CHBSRequestData::getFromWidget(1,'fixed_location_pickup_id')]['formatted_address']); ?>"/>
<?php
				}
?>
...
<?php
				...
				{
?>
								<option value="<?php echo esc_attr($index); ?>" data-location="<?php echo esc_attr(json_encode($value)); ?>" <?php CHBSHelper::selectedIf($this->data['booking_edit']->getFieldValue('fixed_location_pickup_id',array('meta','pickup_location_id'),1),$index); ?>><?php echo esc_html($value['formatted_address']); ?></option>
<?php			  
				}
?>							
							</select>
...
<?php
				...
				{
?>
								<option value="<?php echo esc_attr($index); ?>" data-location="<?php echo esc_attr(json_encode($value)); ?>"<?php CHBSHelper::selectedIf($this->data['booking_edit']->getFieldValue('fixed_location_dropoff_id',array('meta','dropoff_location_id'),1),$index); ?>><?php echo esc_html($value['formatted_address']); ?></option>
<?php			  
				}
?>							
							</select>
...
<?php
				...
				{
?>
								<option value="<?php echo esc_attr($index); ?>" data-location="<?php echo esc_attr(json_encode($value)); ?>"<?php CHBSHelper::selectedIf($this->data['booking_edit']->getFieldValue('fixed_location_pickup_id',array('meta','pickup_location_id'),2),$index); ?>><?php echo esc_html($value['formatted_address']); ?></option>
<?php			  
				}
?>								   
							</select>
...
<?php
					...
					{
?>
								<option value="<?php echo esc_attr($index); ?>" data-location="<?php echo esc_attr(json_encode($value)); ?>"<?php CHBSHelper::selectedIf($this->data['booking_edit']->getFieldValue('fixed_location_dropoff_id',array('meta','dropoff_location_id'),2),$index); ?>><?php echo esc_html($value['formatted_address']); ?></option>
<?php			  
					}
?>									
							</select>
